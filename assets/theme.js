  ...
  cart.prototype.success = function() {
    ...
    $.ajax({
      ...
      success: function(cart){
        ...
        let item_count_string = '';
        if (item_count < 10) {
          item_count_string = `0${item_count}`;
        }
        else {
          item_count_string = item_count;
        }
        $('.cart-numbers').text(item_count_string);
        $('.cart-numbers').css('color', '#10A4CE');
      },
      dataType: 'JSON'
    });
  };
...
theme.ProductRecommendations = (function() {
  function ProductRecommendations(container) {
    ...
    var customer_type = $('#recommendationsCustomerType').val();
